...
static queue_t s_irrQ; // Queue for IR Receiver
static irr_msg_t s_irrBuf[IRR_QUEUE_CAPACITY]; // Q item
...
{
    /* Initialize Queue for IR Receiver Manager */
    queue_init(&s_irrQ, s_irrBuf, IRR_QUEUE_CAPACITY, sizeof(irr_msg_t));
    /* 
