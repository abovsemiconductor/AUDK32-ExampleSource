...
#define PCU_IRQ_PRIO   3
#define PCU_INTR_NUM   12

#define BUTTON_QUEUE_CAPACITY 32
...
static queue_t s_btnQ;										// Q
static btn_msg_t s_btnBuf[BUTTON_QUEUE_CAPACITY];			// Q item
...
{
    // 0. init
    queue_init(&s_btnQ, s_btnBuf, BUTTON_QUEUE_CAPACITY, sizeof(btn_msg_t));
