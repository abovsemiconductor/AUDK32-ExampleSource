...
/*
 * Readme:
 * - This example demonstrates how to use TIMER1 in periodic mode to generate periodic interrupts.
 * - The interrupt handler prints a message every time the timer event occurs.
 * 
 * Connection:
 * - None
 */
