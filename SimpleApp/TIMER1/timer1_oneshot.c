...
/*
 * Readme:
 * - This example demonstrates how to use TIMER1 in one-shot mode to generate a single pulse after a delay.
 * - The interrupt handler prints a message when the timer event occurs.
 * 
 * Connection:
 * - None
 */
...
static void Timer1_IRQHandler(uint32_t un32Event, void *pContext)
{
    ...
    {
        LOG("Timer1 Event Fire.\n");
    }
}

void TIMER1_Oneshot(void)
{
    ...
    tCfg.utData.tGRD.un16DataB = 3200;
