...
/* 
 * Readme:
 * This example demonstrates how to use CRC in CRC-16 CCITT mode.
...
void CRC_16_CCITT(void)
{
    ...
    {
        LOG("CRC-16 CCITT Result mismatch(0x%x, 0x%x)\n", un32Result, CRC_RESULT);
    }
    else
    {
        LOG("CRC-16 CCITT Result (0x%x)\n", un32Result);
    }
}
#endif
