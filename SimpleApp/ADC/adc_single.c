...
/* 
 * Readme:
 * This example demonstrates how to use ADC in single mode with Timer1 trigger.
...
static HAL_ERR_e PRV_ADC_SetTimerSource(void)
{
    ...
    TIMER1_CFG_t tTimer1Cfg = 
    {
        ...
        .utData.tGRD.un16DataA = 13,
        .utData.tGRD.un16DataB = 13
    };
...
void ADC_INIT_Single(void)
{
    ...
    LOG("ADC single mode with Timer1 trigger example\n");
