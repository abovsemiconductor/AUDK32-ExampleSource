...
/* 
 * Readme:
 * This example demonstrates how to use ADC in burst mode with software trigger.
...
void ADC_INIT_Burst(void)
{
    HAL_ERR_e eErr = HAL_ERR_OK;

    LOG("ADC burst mode with software trigger example\n");
