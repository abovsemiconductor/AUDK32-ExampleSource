...
/* 
 * Readme:
 * This example demonstrates how to use WDT in underflow mode and reset the system.
 * 
 * Connection:
 * - None
 */
...
void WDT_Reset(void)
{
    ...
    WDT_CFG_t tCfg =
    {
        .un8Mode = WDT_MODE_CNT | WDT_MODE_RST,
        .un8IntrEnable = WDT_INTR_MATCH,
        .un32InitCnt = 16666,
        .un32MatchCnt = 8333
    };
    ...
    /* Set WDT configuration to reset the system */
